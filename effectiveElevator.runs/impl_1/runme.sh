...
HD_PWD='C:/Users/Cevat Aykan Sevinc/Downloads/Sample_Projects/keypad_7seg/effectiveElevator/effectiveElevator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log effectiveModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source effectiveModule.tcl -notrace
