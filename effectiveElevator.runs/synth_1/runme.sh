...
HD_PWD='C:/Users/Cevat Aykan Sevinc/Downloads/Sample_Projects/keypad_7seg/effectiveElevator/effectiveElevator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log effectiveModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source effectiveModule.tcl
